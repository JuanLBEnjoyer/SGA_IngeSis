package co.edu.uniquindio.proyecto.infraestructure;
...
class SolicitudControllerTest {
    ...
    void debeRetornarListaVaciaCuandoNoHaySolicitudes() throws Exception {
        when(consultarPorEstadoUseCase.ejecutar(null)).thenReturn(List.of());
        when(mapper.toResumenResponseList(List.of())).thenReturn(List.of());
    ...
    void debeRetornarListaFiltradaPorEstado() throws Exception {
        when(consultarPorEstadoUseCase.ejecutar(EstadoDeSolicitud.REGISTRADA))
                .thenReturn(List.of());
        when(mapper.toResumenResponseList(List.of())).thenReturn(List.of());
        ...
        verify(consultarPorEstadoUseCase).ejecutar(EstadoDeSolicitud.REGISTRADA);
    }
